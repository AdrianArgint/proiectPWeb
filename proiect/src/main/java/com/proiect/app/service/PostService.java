...
public class PostService {
    ...
    public PostService(PostRepository postRepository, PostCommentRepository postCommentRepository, PostMapper postMapper) {
    ...
    public void delete(Long id) {
        ...
        postCommentRepository.deleteAllById(postToDelete.get().getComments().stream().map(PostComment::getId).collect(Collectors.toSet()));
