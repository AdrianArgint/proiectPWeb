...
import com.proiect.app.service.PostCommentQueryService;
import com.proiect.app.service.PostCommentService;
...
/**
 * REST controller for managing {@link com.proiect.app.domain.PostComment}.
 */
@RestController
@RequestMapping("/api")
public class PostCommentResource {
    ...
    public ResponseEntity<PostCommentDTO> updatePostComment(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, postCommentDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<PostCommentDTO> partialUpdatePostComment(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, postCommentDTO.getId().toString())
        );
    }
