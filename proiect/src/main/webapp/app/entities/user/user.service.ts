...
export class UserService {
  ...
  queryPlace(placeId: number, req?: Pagination): Observable<HttpResponse<IUser[]>> {
    const options = createRequestOption(req);
    return this.http.get<IUser[]>(`${this.resourceUrl}/place/${placeId}`, { params: options, observe: 'response' });
  }
